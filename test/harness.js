...
const tabEls = ["dashboard", "habits", "finance", "tasks", "workouts", "goals", "focus", "nutrition"].map((v) => { const t = makeEl("button"); t.dataset.view = v; t.classList.add("tab"); if (v === "dashboard") t.classList.add("is-active"); return t; });
...
const document = {
  ...
  querySelectorAll: (sel) => {
    ...
    if (sel === ".view") return ["dashboard", "habits", "finance", "tasks", "workouts", "goals", "focus", "nutrition"].map((v) => byId["view-" + v]);
    return [];
  },
  addEventListener: () => {}
};
...
const files = [
  ...
  "assets/js/icons.js", "assets/js/foods.js",
...
["dashboard", "habits", "finance", "tasks", "workouts", "goals", "focus", "nutrition"].forEach((v) => {
