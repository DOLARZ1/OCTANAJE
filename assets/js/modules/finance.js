...
(function () {
  ...
  const NEWS_LINKS = [
    { icon: "📰", t: "El Economista", d: "Portada", u: "https://www.eleconomista.com.mx/" },
  ...
  function marketsCard() {
    const card = el("div", { class: "card mb-16" }, [
      ...
      el("div", { class: "card-title mt-16", style: "margin-bottom:10px" }, [el("span", { class: "dot" }), "Economía · toca para abrir la fuente"]),
