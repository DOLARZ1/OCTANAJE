...
(function () {
  ...
  const ACHIEVEMENTS = [
    ...
    { id: "fasting_first", name: "Primer ayuno", icon: "🕐", desc: "Cumple tu primer día de ayuno", tier: "common", test: (s) => Object.values((s.fasting && s.fasting.log) || {}).some((e) => e.status === "done") },
